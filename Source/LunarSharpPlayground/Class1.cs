...
namespace LunarSharpPlayground
{
	...
	public class LunarClass
    {
        //static List<ButtplugClientDevice> Devices = new List<ButtplugClientDevice>();
		...
		//[DllExport(CallingConvention.Cdecl)]
		//public static void SetVibration(double Strength)
  //      {
  ...
  //      }
        ...
        private static async Task RunButtplug()
        {
            ...
            var client = new ButtplugClient("Sonic Generations");
