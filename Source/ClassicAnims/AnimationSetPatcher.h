...
public:
    ...
    static NewAnimationDataList m_newAnimationDataClassic;
    static NewAnimationDataList m_newAnimationDataClassicSuper;
    ...
    static const char* volatile const ExtraFall;
};
